<template>
  <div id="container" class="mt-9 flex flex-col justify-center">
    <h1 id="heading" class="text-4xl sm:text-5xl font-bold text-center">
      CONTACTS
    </h1>
    ...
    <div id="description" class="flex justify-center my-6">
      <div
        v-if="buttonType === 'join'"
        class="bg-white rounded-3xl w-5/6 md:w-3/4 xl:w-7/12 p-4 md:p-12"
      >
        <JoinUs></JoinUs>
      </div>
      <div
      ...
      >
        <Staff :pta-members="ptaMembers"></Staff>
      </div>
      <div
        v-if="buttonType === 'slt'"
        class="bg-white rounded-3xl w-11/12 md:w-3/4 xl:w-7/12 pt-4 md:p-12"
