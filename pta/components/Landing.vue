    ...
    <div class="grid lg:grid-cols-2 my-16 mx-2">
        ...
        <div class="mx-4 md:mx-16 lg:mx-10 flex flex-col justify-center">
            <div id="upcomingEvents">
                <h3 class="subh flex items-center gap-2 font-bold text-xl mb-3 text-[#4b3a23]">
                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" class="w-5 h-5 fill-current">
